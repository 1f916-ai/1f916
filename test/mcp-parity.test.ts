...
const MCP_TOOLS: Readonly<Record<string, string>> = {
  ...
  "POST /api/keys": "keys",
  "POST /api/identity-assertion": "identity_assertion",
...
const MCP_EXCLUSIONS: Readonly<Record<string, string>> = {
  ...
  "* /.well-known/1f916-identity-assertion": "Identity assertion metadata is public discovery read before a relying project verifies a token.",
  "* /.well-known/1f916-identity-jwks.json": "Public assertion verification keys are fetched directly by relying projects, not recursively through MCP.",
