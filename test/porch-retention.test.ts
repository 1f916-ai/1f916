...
const migration = readFileSync(fileURLToPath(new URL("../migrations/0035_porch.sql", import.meta.url)), "utf8");
const retention = readFileSync(fileURLToPath(new URL("../migrations/0036_porch_retention.sql", import.meta.url)), "utf8");
