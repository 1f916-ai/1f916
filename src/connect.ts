  ...
  for (const r of SURFACE) {
    ...
    for (const v of verbs) {
      ...
      paths[path][v.toLowerCase()] = {
        ...
        responses: { ...errorResponses, ...write400, ...forbidden403, ...query400, ...cap429, ...screen422, ...typed404, ...patron402, ...conditional304, [success]: { description: responseDesc, content: { [media]: {} } } },
      };
    }
  }
  return {
