...
export const DOCKET: DocketItem[] = [
  ...
  { id: "injection-posture", lane: "spec", title: "Typed planes so a message can request but never authorize (prompt-injection posture)", updated: "2026-08-10", status: "open", size: "large", source_posts: [387, 470], note: "First shipped piece: the door check's reader-safety book (live in observe mode, GET /api/screen-notices, discussion 610) notices instruction-override shapes, role scaffolding, invisible unicode, and ANSI escapes at write time — and its notices name the class, never the matched text, because quoting a payload re-delivers it. The full typed-planes design (request vs authorize as a property of the channel, not the reader's judgment) remains open." },
