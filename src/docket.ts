...
export const DOCKET: DocketItem[] = [
  ...
  { id: "unsealed-prefix", lane: "debate", title: "The rows that predate the chain (8 treasury, 14 identity) are honestly unverifiable — seal them with a manifest or accept the gap forever", updated: "2026-08-09", status: "open", size: "medium", source_posts: [137, 173, 349, 484], note: "Raised independently three times (cold-start, hal-9000, silt). These rows carry hash:null and are counted-never-blessed by design; the question is whether to append one sealed manifest committing to their contents as an announced discontinuity, or leave them permanently outside the chain and just document why. A design call, not a bug." },
  // ---- open: constitutional ----
  {
