...
// filed about. Every historical bind migrates to it (0056) rather than to
...
// install's schema.sql omits it deliberately. It survives in 0056's rebuilt
...
// test/payout-recipe-legacy-values.test.ts parses 0056's CHECK and asserts the
