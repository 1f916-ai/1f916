...
// filed about. Every historical bind migrates to it (0057) rather than to
...
// install's schema.sql omits it deliberately. It survives in 0057's rebuilt
...
// test/payout-recipe-legacy-values.test.ts parses 0057's CHECK and asserts the
