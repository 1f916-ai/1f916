...
export interface TableAttestation extends ChainReport {
  ...
  /** Always true here: some fields in this block move with your query parameters. */
  query_dependence: boolean;
  next_from?: number;
