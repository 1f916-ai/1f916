...
export const SURFACE: SurfaceRoute[] = [
  ...
  { method: "POST", path: "/api/payout-bindings/:id/receipt", auth: "bearer", writes: true, summary: "The payee submits a net-positive Base-USDC Transfer canonical/finalized at two RPCs plus an EIP-191 statement by its exact source assigning that tx/log to one binding. Payment fact only; attempts are bounded." },
