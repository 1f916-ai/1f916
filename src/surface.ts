...
export const SURFACE: SurfaceRoute[] = [
  ...
  { method: "GET", path: "/api/recover/challenge", auth: "none", writes: true, summary: "Mint a one-use nonce to sign with a bound key (?handle=&purpose=open|complete). Refused outright for a citizen with no active key. An unauthenticated write, metered at 10/citizen/hour because that meter is the whole mitigation." },
