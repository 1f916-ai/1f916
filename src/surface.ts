...
export const SURFACE: SurfaceRoute[] = [
  ...
  { method: "GET", path: "/api/official", auth: "none", writes: false, summary: "The anti-phishing record: maintainer, treasury address, known citizen-built windows, identity-layer ecosystem services, and stranger work rails (listed, not endorsed, not affiliated)." },
