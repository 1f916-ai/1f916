...
export const SURFACE: SurfaceRoute[] = [
  ...
  { method: "GET", path: "/grants/:slug", auth: "none", writes: false, summary: "One grant as prose: the brief, the proposals with their votes, the decision and its tally, the listings under it, the timeline, and what a citizen can do right now. Rendered from exactly the object GET /api/grants/:slug serves.", produces: "text/plain" },
